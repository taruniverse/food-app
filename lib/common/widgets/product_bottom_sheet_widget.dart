                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            (widget.product!.description != null && widget.product!.description!.isNotEmpty) ? Column(
                              ...
                              children: [
                                ...
                                Text(widget.product!.description ?? '', style: robotoRegular, textAlign: TextAlign.justify),
                                ...
                                return Container(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                      Text(widget.product!.variations![index].name!, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                        ...
                                        child: Text(
                                          ...
                                          style: robotoRegular.copyWith(
                                            color: widget.product!.variations![index].required!
                                                ? (widget.product!.variations![index].multiSelect! ? widget.product!.variations![index].min! : 1) <= selectedCount ? Theme.of(context).primaryColor : Theme.of(context).colorScheme.error
                            ...
                            SizedBox(height: (widget.product!.variations != null && widget.product!.variations!.isNotEmpty) ? 0 : 0),
