        ...
        Shimmer(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Get.isDarkMode ? Colors.white.withOpacity(0.05) : Get.isDarkMode ? Colors.white.withOpacity(0.05) : Get.isDarkMode ? Colors.white.withOpacity(0.05) : Colors.grey[300],
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Icon(Icons.favorite_border, size: 25, color: Get.isDarkMode ? Theme.of(context).disabledColor.withOpacity(0.2) : Theme.of(context).cardColor),
                const SizedBox(width: Dimensions.paddingSizeSmall),
                Icon(Icons.share, size: 25, color: Get.isDarkMode ? Theme.of(context).disabledColor.withOpacity(0.2) : Theme.of(context).cardColor),
              ],
            ),
          ),
        ),
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                ...
                Column(children: [
                  Icon(Icons.star, color: Get.isDarkMode ? Theme.of(context).disabledColor.withOpacity(0.2) : Theme.of(context).cardColor),
                ...
                Column(children: [
                  Icon(Icons.location_on, color: Get.isDarkMode ? Theme.of(context).disabledColor.withOpacity(0.2) : Theme.of(context).cardColor),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  Container(
                    height: 10, width: 50,
                    decoration: BoxDecoration(
                ...
                Column(children: [
                  Icon(Icons.timer_rounded, color: Get.isDarkMode ? Theme.of(context).disabledColor.withOpacity(0.2) : Theme.of(context).cardColor),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  Container(
                    height: 10, width: 50,
                    decoration: BoxDecoration(
