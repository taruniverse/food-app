...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb) {
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyCu7WSNogWWw3aCY1SjDbzb2Z0UtoajTnw',
      appId: '1:1047192529538:android:434f49e5711ca33061e29b',
      messagingSenderId: '1047192529538',
      projectId: 'foodsqureuser',
    ));
    MetaSEO().config();
